...
GratingCouplerNet = torch.load("GratingCouplerNetModel_adam_lr_001_wd_0005")
...
for epoch in range(max_epoch):
    ...
    # Save the model
    torch.save(GratingCouplerNet, 'GratingCouplerNetModel_adam_lr_001_wd_0005_new')
    ...
    dataframe.to_csv('losses_adam_lr_001_wd_0005_new.csv')
