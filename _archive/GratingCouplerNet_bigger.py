...
for epoch in range(max_epoch):
    ...
    # if epoch > 10:
    #     print("Validation progress: {:.6f}".format(get_progress(validation_losses[epoch-10], validation_loss.detach().numpy())))

    # if epoch > 10 and check_progress(validation_losses[epoch-10], validation_loss.detach().numpy()):
    #     learning_rate = learning_rate / 2
    #     optimizer = torch.optim.Adam(GratingCouplerNet.parameters(), lr=learning_rate, weight_decay=weight_decay)


    # Save the model
    torch.save(GratingCouplerNet, 'GratingCouplerNetModel_nn_6_50_100_1')
    ...
    dataframe.to_csv('losses_nn_6_50_100_1.csv')
