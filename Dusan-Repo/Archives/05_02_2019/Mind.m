        ...
        function train(obj, num_epochs, test_data)
            ...
            for n = 1:floor(obj.sample_size/obj.batch_size)
                batches(end + 1).features =...
                    features(((n - 1)*obj.batch_size + 1):n*obj.batch_size, :);
                batches(end).labels =...
            ...
            for m = 1:num_epochs
                ...
                for k = 1:length(batches)
                    ...
                    error = mean(mean(abs((obj.scale(labels, 'l') -...
                        obj.layers(end).out))));
...
%             error = 100*abs(labels - predictions)./labels;
%             test_error = mean(error);
        ...
        function publish(obj)
            ...
            new_model = Model(obj.data.inputs, obj.data.outputs,...
                obj.weights, obj.biases, activation_functions,...
                obj.feature_ranges, obj.label_ranges);
